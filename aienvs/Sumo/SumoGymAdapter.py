...
class SumoGymAdapter(Env):
    ...
    def reset(self, episode=None):
        ...
        if episode!=None:
            average_travel_times, average_travel_time, average_speed = self.stats_control.log()
            ...
            return self._observe(), average_travel_times, average_travel_time, average_speed
